...
namespace ECommerceCore.Infrastructure.Services.Authorization
{
        ...
        ILogger<PermissionService> logger) : IPermissionService
    {
        ...
        public async Task AddPermissionToRoleAsync(string roleName, string permission)
        {
            ...
            var permissionEntity = await _dbContext.Set<Permission>()
            ...
            if (permissionEntity == null)
            {
                ...
                _dbContext.Set<Permission>().Add(permissionEntity);
