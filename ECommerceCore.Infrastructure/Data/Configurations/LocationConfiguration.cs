...
#region
// Company: Many-to-one (Location belongs to one Company, a Company can have many Locations).
// Currency: Many - to - one(Location uses one Currency, a Currency can be used by many Locations).
// Timezone: Many - to - one(Location uses one Timezone, a Timezone can be used by many Locations).
// Invoices: One - to - many(a Location can have many Invoices).
#endregion