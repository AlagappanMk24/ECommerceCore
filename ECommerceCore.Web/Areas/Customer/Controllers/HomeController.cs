...
namespace ECommerceCore.Web.Areas.Customer.Controllers
{
    ...
    public class HomeController : Controller
    {
        ...
        public IActionResult Index()
        {
            ...
            {
                //Adding session
                HttpContext.Session.SetInt32(AppConstants.SessionCart, _unitOfWork.ShoppingCart.GetAll(u => u.ApplicationUserId == claims.Value).Count());
            }
        ...
        public IActionResult Details(ShoppingCart shoppingCart)
        {
            ...
            else
            {
                ...
                //Adding session
                HttpContext.Session.SetInt32(AppConstants.SessionCart, _unitOfWork.ShoppingCart.GetAll(u => u.ApplicationUserId == userId).Count());
            }
